...
def resumir_link():
    ...
    try:
        gpt_response = client.chat.completions.create(
            model="gpt-4",
            messages=[
                {"role": "system", "content": "Atue como um influenciador tech, especialista em linkedin. Transforme os textos que receber em postagens leves, de fácil leitura, sem emojis, caracteres especiais e quebra de linha"},
